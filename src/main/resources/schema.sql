...
CREATE TABLE IF NOT EXISTS meeting_room (
  ...
  created_id VARCHAR(255) NOT NULL DEFAULT 'SYSTEM',
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_id VARCHAR(255) NOT NULL DEFAULT 'SYSTEM',
  PRIMARY KEY (room_id)
)/;
...
CREATE TABLE IF NOT EXISTS usr (
  ...
  account_lock_flg VARCHAR(1) NOT NULL DEFAULT '0',
  init_flg VARCHAR(1) NOT NULL DEFAULT '0',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  created_id VARCHAR(255) NOT NULL DEFAULT 'SYSTEM',
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_id VARCHAR(255) NOT NULL DEFAULT 'SYSTEM',
